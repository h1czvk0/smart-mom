...
export const reportRecords = [
  ...
  {
    taskId: 'WO-20260606-002',
    time: '2026-06-06 10:45',
    process: '扭矩复检',
    device: 'A03 扭矩检测台',
    finishedQty: 800,
    badQty: 2,
    status: '正常',
    remark: '扭矩复检批次完成，参数稳定。',
  },
  {
    taskId: 'WO-20260606-004',
  ...
  {
    taskId: 'WO-20260606-006',
    time: '2026-06-06 11:35',
    process: '包装入库',
    device: 'D02 包装线',
    finishedQty: 500,
    badQty: 0,
    status: '正常',
    remark: '包装入库整批完成，账物一致。',
  },
  {
    taskId: 'WO-20260606-007',
    time: '2026-06-06 12:20',
    process: 'ICT 测试',
    device: 'C03 测试夹具',
    finishedQty: 1000,
    badQty: 3,
    status: '正常',
    remark: 'ICT 测试完成，少量不良已隔离。',
  },
  {
  ...
  {
    taskId: 'WO-20260606-009',
    time: '2026-06-06 14:10',
    process: '整机组装',
    device: 'B02 组装工位',
    finishedQty: 700,
    badQty: 1,
    status: '正常',
    remark: '整机组装完成，等待包装确认。',
  },
  {
    taskId: 'WO-20260606-010',
  ...
  {
    taskId: 'WO-20260606-011',
    time: '2026-06-06 15:25',
    process: '三防涂覆',
    device: 'C01 涂覆机',
    finishedQty: 1100,
    badQty: 2,
    status: '正常',
    remark: '三防涂覆批次完成，膜厚抽检合格。',
  },
  {
    taskId: 'WO-20260606-012',
    time: '2026-06-06 16:10',
    process: '贴合检测',
    device: 'D01 贴合机',
    finishedQty: 520,
    badQty: 12,
    status: '异常',
    remark: '贴合检测不良率偏高，已要求复核来料批次。',
  },
]
