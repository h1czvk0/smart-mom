...
基于 Vue 3 + Vite 开发的数字化车间生产任务管理前端系统，用于《前端技术开发项目实训》。项目围绕工单、产线、设备、工序、报工、生产报表和 AI 小结构建，重点展示 Vue 单页应用、组件化页面、Vue Router、核心交互功能、响应式适配和项目联调测试。
...
本项目使用本地 mock 数据模拟生产任务、设备状态和报表统计数据，暂未接入真实后端接口。AI 报表小结为前端模拟生成，后续可以替换为真实大模型接口请求。
